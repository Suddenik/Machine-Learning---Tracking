...
namespace OgarniatorDanych_v2
{
    class Program
    {
        ...
        private static int ConvertTry(long startindex, string LanguageChoice_)
        {
            //long avg = 0;
                ...
                using (StreamWriter sw = File.AppendText(outputPath))
                {
                    ...
                    try
                    {
                        ...
                        while ((line = sr.ReadLine()) != null)
                        {
                            ...
                            string fixedLine = FixLine(line, LanguageChoice_);
                            if (fixedLine != null)
                            {
        ...
        private static string FixLine(string line, string LanguageChoice_)
        {
            string fixedLine = "";
            int debugMax = 0;
            ...
            try
            {
                ...
                tempLine = tempLine.Replace(" ", "");
                if (!tempLine.Equals("PL") && LanguageChoice_.Equals("y"))
                    return null;
                //tempLine = tempLine.GetHashCode().ToString();
                tempLine += ";";
                fixedLine += tempLine;
        ...
        static void Main(string[] args)
        {
            ...
            GatherFileData();
            ///////////////////
            Console.WriteLine("Czy odczytać dane wyłącznie z Polski? [y/n]:");
            string LanguageChoice = Console.ReadLine();
            ///////////////////
            ConvertTry(5, LanguageChoice);
